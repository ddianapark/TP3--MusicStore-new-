...
public class Catalogo
{
    ...
    public static void InicializarCatalogo()
    {
        ...
        Disco brunoMars = new Disco("2", "24K Magic", "Bruno Mars", "Bruno Mars, Shampoo Press & Curl", "Funk / R&B", new List<string> { "24K Magic", "Chunky", "That's What I Like", "Versace on the Floor" }, "/images/24K2.png");
        ...
        Disco Uncorazon = new Disco ("4","Somos Iglesia","Un Corazón", "Steven Richards", "Cristiano", new List<string> { "Somos Iglesia", "Alabanza", "Jesús", "Libre" }, "/images/1H.png");
        ...
        Disco Theweeknd = new Disco ("6", "After Hours", "The Weeknd", "Max Martin, Metro Boomin", "Synthpop / R&B", new List<string> { "Blinding Lights", "Save Your Tears", "Heartless" }, "/images/after2.png" );
        ...
        Disco TaylorSwift = new Disco ("10", "Evermore", "Taylor Swift", "Aaron Dessner, Jack Antonoff", "Indie Folk", new List<string> { "willow", "champagne problems", "no body, no crime" }, "/images/tay.png");
